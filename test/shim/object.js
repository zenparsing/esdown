export var tests = {
    ...
    "assign" (test) {
        ...
        .throws($=> Object.assign(target = {}, null), TypeError)
        .throws($=> Object.assign(target, void 0), TypeError)
        .throws($=> Object.assign(target, true), TypeError)
        .throws($=> Object.assign(target, { a: 1 }, void 0), TypeError)
        
        ._("target is partially modified is error is thrown")
        .equals(target, { a: 1 })
        
        ._("all sources are iterated when error is thrown")
        .throws($=> Object.assign(target = {}, void 0, { a: 1 }), TypeError)
        .equals(target, { a: 1 })
